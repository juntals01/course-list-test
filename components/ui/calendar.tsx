  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          'flex items-center justify-center h-(--cell-size) w-full px-(--cell-size) text-primary',
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[selected-single=true]:bg-[var(--third)] data-[selected-single=true]:text-primary',
        // Range selection styles
        'data-[range-middle=true]:bg-[var(--highlight)] data-[range-middle=true]:text-accent-foreground',
        'data-[range-start=true]:bg-[var(--third)] data-[range-start=true]:text-primary',
        'data-[range-end=true]:bg-[var(--third)] data-[range-end=true]:text-primary',
        // Focus and hover styles
        // "group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50",
        'hover:bg-[var(--third)] hover:text-primary',
        // Layout and sizing
        'flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1',
        'leading-none font-normal',
        // Focus ring styles
        // "group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px]",
        // Range border radius styles
