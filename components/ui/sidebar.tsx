...
const SIDEBAR_WIDTH_MOBILE = '15rem'; // 240px to match Figma design
const SIDEBAR_WIDTH_ICON = '3rem';
const SIDEBAR_KEYBOARD_SHORTCUT = 'b';

// Rename the type alias to avoid conflict with the context variable.
...
function SidebarProvider({
  ...
  // Use server-provided value on initial render, then client-side detection for responsiveness
  const [isMobile, setIsMobile] = React.useState(initialIsMobile);
  
  React.useEffect(() => {
    // After mount, use client-side detection for window resize handling
